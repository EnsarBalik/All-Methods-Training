...
public class cubeHealth : Health, IDamageable<int>
{
    ...
    protected override void hitFeedBack()
    {
        ...
        Tween colorTween = myMat.DOBlendableColor(Color.green, 0.1f);
        colorTween.OnComplete(() => myMat.DOBlendableColor(Color.cyan, 0.05f));
    }
